...
int number_of_partition = 8; // to keep things simple, let number_of_partition = multiple of num_cu

/* meta-data */
int hidden_dim = 128; //48, 128
int output_dim = 100; //30, 47
...
int main(int argc, char** argv)
{
    ...
    read_file <index_type> ("../yelp/indices.bin", col_idx);
    read_file <index_type> ("../yelp/indptr.bin", row_ptr);
    //read weight
